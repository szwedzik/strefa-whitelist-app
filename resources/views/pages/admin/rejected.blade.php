                        ...
                        <div class="card">
                            <div class="card-header pb-0 mb-0">
                                ...
                                <ul class="nav nav-tabs nav-tabs-sm nav-overflow">
                                    ...
                                    <li class="nav-item">
                                        <a href="/admin/rejected" class="nav-link active">
                                            Odrzucone ({{ $rejected }})
                                        </a>
                                    </li>
                                    <li class="nav-item">
                            ...
                            @if($applications->count() > 0)
                                <div class="table-responsive">
                                    <table id="rejected" class="table table-sm card-table">
                                        <thead>
                                        <tr>
                                            <th>
                                                Kto
                                        ...
                                        @foreach($applications as $application)
                                            <tr>
                                                ...
                                                <td>
                                                    <span class="badge badge-soft-danger"><i class="fe fe-close"></i> Odrzucona</span>
                                                </td>
                                                <td>
                                                ...
                                                <td class="text-right">
                                                    ...
                                                    <a href="/admin/{{ $application->uuid }}/accept" class="btn btn-sm btn-white">
                                                        Akceptuj
                                                    </a>
                                                </td>
                                            </tr>
